...
namespace AniSuki.Util
{
    public static class DataAccess
    {
        ...
        public static Resolution UpdateAnimeResolution(Resolution resolution, int animeID)
        {
            ...
            using(DataSet ds = ExecuteQuery(sql, new[] {new SqlParameter(@"@Width", SqlDbType.SmallInt) {Value = resolution.Width}, new SqlParameter(@"@Height", SqlDbType.SmallInt) {Value = resolution.Height}, new SqlParameter(@"@AnimeID", SqlDbType.Int){Value = animeID}, new SqlParameter(@"@ResString", SqlDbType.NVarChar){Value = resolution.ResolutionString}}))
            {
